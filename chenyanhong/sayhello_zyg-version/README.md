...
1. 出现bug：pip无法使用；查阅资料发现需要升级到最新版本。
2. 创建虚拟环境并激活
```
pip install pipenv
pipenv shell
...
```
* flask上下文：
    ![9f835fbf944b096196bcabc1e8e6a060.png](en-resource://database/5888:1)
...
```
* 全局对象:为模板提供公共的方法
![2a8c3a795601f2ae314b218ea70b2fc7.png](en-resource://database/5893:1)
自定义：
```python
@app.template_global()
def func():
...
![98759cbfb76e6cafb97905e902242fee.png](en-resource://database/5898:1)
//这里只列出了一部分常用的过滤器
...
```
![3f9331c444e3d1c112013482d624c61d.png](en-resource://database/5906:1)
...
* 建立关系
    * 一对多
        1. 建立外键：db.ForeignKey('xx.id')
        2. 定义关系属性：db.relationship('xxx')
        3. 给外键字段赋值或者调用append()
    * 多对多
    * 多对一
    * 一对一
